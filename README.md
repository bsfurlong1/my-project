...
7. A **NFL Picks** menu appears in the sheet. Run, in order:
   - **1. Initialize (fetch schedule)** — opens a small dialog that fetches
     ...
     prompted; this can take a minute or two the first time.
   - **2. Add Member** — once per person in your league.
8. Share the spreadsheet (edit access) with your league. Each person checks
